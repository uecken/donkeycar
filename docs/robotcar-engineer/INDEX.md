...
このフォルダには、picopico_racersプロジェクト（HBX 2192ベース）のPWM制御・モータードライバー関連調査資料、およびコントローラー統合ガイドが含まれています。
...
| ファイル | 役割 | 主な内容 |
|----------|------|----------|
| [DonkeyCar起動ガイド](./20260129-1830_DonkeyCar起動ガイド.md) | **起動方法の総合ガイド** | manage.py drive、ジョイスティック、自動運転、キャリブレーション、データ収集 |

### コントローラー関連

| ファイル | 役割 | 主な内容 |
|----------|------|----------|
| [M5C_JOYCON_DonkeyCar統合ガイド](./20260129-1600_M5C_JOYCON_DonkeyCar統合ガイド.md) | **BLE Gamepadの統合手順** | M5C_JOYCON仕様、BLEペアリング、Donkey Car設定、カスタムコントローラー作成 |
| [M5C_JOYCON動作問題調査](./20260129-2100_M5C_JOYCON動作問題調査.md) | **BLE切断・モーター不動作調査** | BLE ERTM問題、軸マッピング不一致、カスタムコントローラー作成 |
| [Joystick認識問題調査](./20260129-1200_Joystick認識問題調査.md) | **USE_JOYSTICK_AS_DEFAULT問題** | myconfig.py設定の確認方法、解決策 |
...
| [HBX2192制御調査](./20260128-2010_HBX2192制御調査.md) | **HBX 2192固有の情報** | 車両仕様、5線式サーボ問題、推奨構成、HW/SW PWM混在検討、ESC突入電流対策 |
...
| 症状 | 原因 | 解決策 |
|------|------|--------|
| 電源投入時「カカカカ...」とモーターが小刻みに動いて停止 | モーター突入電流によるESC起動失敗 | **470μF/25V電解コンデンサをESC電源に追加** |

- 正常起動時: ESCから「ピッピピピ」と確認音が鳴る
...
| 2026年1月29日 | M5C_JOYCON_DonkeyCar統合ガイド追加 |
